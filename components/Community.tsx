      ...
      <div className="bg-chef-black text-white pt-24 pb-20 px-6 sticky top-0 z-30 shadow-2xl relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-end gap-10 relative z-10">
          <div>
            ...
            <p className="text-stone-500 font-medium text-lg font-serif">遇見全球味覺趨勢，與大數據共同編織下一道經典。</p>
          </div>
        ...
        {activeTab === 'explore' && (
          <div className="space-y-16">
            ...
            <div className="animate-fadeIn">
              <div className="flex items-center gap-4 mb-8">
                <div className="h-px bg-stone-200 flex-1"></div>
                <h2 className="text-[10px] font-black uppercase tracking-[0.5em] text-stone-500">全球趨勢探索 Global Feed</h2>
                <div className="h-px bg-stone-200 flex-1"></div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            {isLoading ? (
              ...
              <div className="space-y-16">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-stone-500 italic max-w-2xl mx-auto leading-relaxed">{report.globalInsight}</p>
                </div>
                    ...
                    <div className="space-y-8">
                      {report.marketTrends.map((trend, i) => (
                        <div key={i}>
                          ...
                          <p className="mt-3 text-[10px] text-stone-500 leading-relaxed font-medium">{trend.description}</p>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-[3rem] p-10 shadow-premium border border-stone-100 sticky top-40">
                ...
                <div className="space-y-8">
                  <div onClick={() => fileInputRef.current?.click()} className={`aspect-video rounded-[2rem] border-2 border-dashed flex items-center justify-center cursor-pointer transition-all ${draftImage ? 'border-chef-gold' : 'border-stone-200 hover:bg-chef-cream/30'}`}>
                    {draftImage ? <img src={draftImage} className="w-full h-full object-cover rounded-[2rem]" alt="Draft" /> : <div className="text-center"><Camera className="mx-auto text-stone-300 mb-2" size={32} /><p className="text-[10px] font-black text-stone-500 uppercase">上傳成品照</p></div>}
